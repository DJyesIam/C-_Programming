...
namespace Labeling
{
    static class LabelingCV
    {
        ...
        public static CvBlob[] FindBlobs(Mat matBin, out Mat resultMat)
        {
            ...
            //blobs.RenderBlobs(matBin, resultMat, RenderBlobsMode.BoundingBox);    // 과제 : 바운딩박스 그리지 않게 수정함
            blobs.RenderBlobs(matBin, resultMat, RenderBlobsMode.Color);
            //blobs.RenderBlobs(matBin, resultMat, RenderBlobsMode.Centroid);       // 과제 : 중심점 그리지 않게 수정함
